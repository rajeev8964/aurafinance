...
const authenticateApiKey = (req, res, next) => {
  ...
  const expectedApiKey = process.env.API_KEY || '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';
  console.log('API Key received:', apiKey ? 'present' : 'missing');
  console.log('Expected API Key:', expectedApiKey ? 'present' : 'missing');
